  ...
  <Card style="width: 100%" :dis-hover="true">
    <Row style="padding: 5px">
      <Card :bordered="true" :dis-hover="true">
        <p slot="title">实体信息</p>
        <Form
          :model="entityFormItem"
          ref="entityFormItem"
          :rules="entityRuleValidate"
          :label-width="130"
        >
          <Row>
            <Col span="12">
          ...
          <Row>
            ...
            <Col span="12">
              <FormItem label="审核用户键类型：">
                <Select
                  style="width: 260px"
                  v-model="entityFormItem.auditedUserKeyType"
                >
            ...
            <Col span="12">
              <FormItem label="主键类型：" prop="primaryKeyType">
                <Select
                  style="width: 260px"
                  v-model="entityFormItem.primaryKeyType"
                >
                  <Option value="Guid">Guid</Option>
                  <Option value="string">String</Option>
                  <Option value="int">Int</Option>
    ...
    <Row style="padding: 5px">
      <Card :bordered="true" :dis-hover="true">
        <p slot="title">项目信息</p>
        <Form
          :model="projectFormItem"
          :label-width="80"
          ref="projectFormItem"
          :rules="projectRuleValidate"
        >
