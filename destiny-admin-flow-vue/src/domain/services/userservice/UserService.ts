...
export default class UserService implements IUserService {
  ...
  deleteUserById(_id: string): Promise<IAjaxResult> {
    return MainManager.dataRequest.deleteRequest(UserApi.deleteUser, {
      id: _id,
    });
  }
